...
<head>
    <meta charset='utf-8'>
    <title>Cadastro de Automotor | Gerencia!</title>
...
<body>
    ...
    <div class="container">
        <div class="titulo_form">Cadastro de Automotor:</div>
            <div class="caixa_form">
                <form action="action_automotor.php" method="POST">
                ...
                <div class ="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class ="alinhar col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            ...
                            <input type="text" id="placa" name="placa" placeholder="Ex: IQJ2345" class="input_cadastro" pattern=".{7,7}" required>
                        </div>
                        
                        <div class="alinhar col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <label for="marca" class="label_cad"> Marca/Modelo </label>
                            <input type="text" id="marca" name="marca" placeholder="Informe a marca e o modelo do automotor." class="input_cadastro" required>
                        </div>
                    </div>
                    <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">    
                    ...
                    <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="alinhar col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            ...
                            <input type="text" id="renavam" name="renavam" placeholder="Informe o nº do renavam do automotor." class="input_cadastro" pattern=".{11,11}" required>
                        </div>
                        <div class="alinhar col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <label for="chassi" class="label_cad"> Chassi</label>
                            <input type="text" id="chassi" name="chassi" placeholder="Informe o nº do chassi do automotor. " class="input_cadastro" pattern=".{17,17}" required>
                        </div>
                    </div>
                    ...
                    <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">    
                        <div class="alinhar col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <input type="text" id="antt" name="antt" placeholder="Informe a ANTT automotor. " class="input_cadastro" pattern=".{11,11}" required>
                        </div>
                    </div>
