...
<body>
    ...
    <div class="container"> 
        <div class="titulo_form">Dados da carreta:</div>
            ...
            <form action="action_altCarreta.php" method="POST">


                <?php
                  echo "<input type='hidden' id='id_carreta' name='id_carreta' value=".$carreta['id_carreta'].">";
                ?>
                    ...
                    <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class ="alinhar col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            ...
                            <?php
                                echo "<input type='text' id='placa' name='placa' value=".$carreta['placa']." class='input_cadastro'>";
                            ?>
                        </div>
                        ...
                        <div class="alinhar col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            ...
                            <?php
                                echo "<input type='text' id='marca' name='marca' value=".$carreta['marca']." class='input_cadastro'>";
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">    
                        ...
                        <?php
                            echo "<input type='date' id='ano' name='ano' value=".$carreta['ano']." class='input_cadastro'>";
                        ?>
                        </div>
                    </div>
                    ...
                    <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="alinhar col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            ...
                            <?php
                                echo "<input type='text' id='renavam' name='renavam' value=".$carreta['renavam']." class='input_cadastro'>";
                            ?>
                        </div>
                        <div class="alinhar col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <label for="chassi" class="label_cad"> Chassi</label>
                            <?php
                                echo "<input type='text' id='chassi' name='chassi' value=".$carreta['chassi']." class='input_cadastro'>";
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">    
                        <div class="alinhar col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <?php
                                echo "<input type='text' id='antt' name='antt' value=".$carreta['antt']." class='input_cadastro'>";
                            ?>
                        </div>
                    </div>
